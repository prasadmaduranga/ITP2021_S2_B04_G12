...
<div class="container body">
                    ...
                    <div class="col-md-12 col-sm-12" style="float: right; position: relative;display: inline-block">
                        <div class="x_panel">
                            ...
                            <button onclick="getValue();return false" ;
                                    style="float: right; font-weight: bold;color: #c6d4d3" ;
    ...
    <footer>
        <div class="pull-right">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Copyright © Hotel SAPPHIRE MARRIOTT 2021<a href="https://github.com/IT20228644/ITP2021_S2_B04_G12">Created by ITP2021_S2_B04_G12</a>
        </div>
        <div class="clearfix"></div>
    </footer>
    <!-- /footer content -->
