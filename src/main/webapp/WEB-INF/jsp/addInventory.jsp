                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Add Item <small>Hotel Sapphire Mariott</small></h3>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <button type="button" style=" border: 5px solid rgb(64, 45, 34);background-color: #a98e77;
                                    color: #f8f9fa;font-weight: bolder" class="btnq2 btn" onclick="getdata();">
                                        Demo
                                    </button>
                                </div>
                            </div>
